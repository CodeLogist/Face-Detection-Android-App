...
#ifndef ZOETICAICHALLENGE_FACE_DETECTION_JNI_LONG_FIELD_H
#define ZOETICAICHALLENGE_FACE_DETECTION_JNI_LONG_FIELD_H
...
#endif //ZOETICAICHALLENGE_FACE_DETECTION_JNI_LONG_FIELD_H
