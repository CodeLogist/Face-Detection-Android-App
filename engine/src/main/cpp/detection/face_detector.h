...
#ifndef ZOETICAICHALLENGE_FACE_DETECTION_FACE_DETECTOR_H
#define ZOETICAICHALLENGE_FACE_DETECTION_FACE_DETECTOR_H
...
#endif //ZOETICAICHALLENGE_FACE_DETECTION_FACE_DETECTOR_H
